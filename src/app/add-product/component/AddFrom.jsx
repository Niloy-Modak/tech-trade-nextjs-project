    ...
    return (
        <div>
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full border border-gray-300 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400 transition"
                            required
                        />
                    </div>
                    <div>
                ...
                <button
                    type="submit"
                    className="w-full cursor-pointer bg-gray-800 text-white py-3 rounded-lg font-medium hover:bg-gray-700 transition-all duration-200 shadow-md hover:shadow-lg"
                >
                    Submit Product
                </button>
            </form>
